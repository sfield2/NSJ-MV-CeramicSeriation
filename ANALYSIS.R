...
#### ***NOTE ****
#### If you don't want to build calibration seriation, skip STEP #1.0 & #1.1 
...
######### STEP #1.1: CALCULATE TOTAL NUMBER OF SHERDS IN CALIBRATION GROUPS ####
...
######### STEP #4.2: PLOT
png('.../FIGURES/Example_output.png',height=650,width=1800)
ggplot()+
